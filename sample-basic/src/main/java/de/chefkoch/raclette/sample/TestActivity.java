...
@Bind(viewModel = TestViewModel.class, layoutResource = R.layout.character_activity)
public class TestActivity extends RacletteRxAppCompatActivity<TestViewModel, CharacterActivityBinding> implements NavRequestInterceptor {
